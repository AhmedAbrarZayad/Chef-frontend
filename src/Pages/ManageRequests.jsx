                        ...
                        <table className="w-full">
                            <thead className="bg-gray-900 text-white">
                                <tr>
                                    ...
                                    <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider">User Email</th>
                                    <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider">Request Type</th>
                                    <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider">Status</th>
                                    <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider">Request Time</th>
                                    ...
                                    >
                                        <td className="px-6 py-4">
                                            <div className="flex items-center">
                                                <div className="text-sm font-semibold text-gray-900">{request.userName}</div>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4">
